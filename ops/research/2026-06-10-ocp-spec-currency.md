...
| 2 | "Deschutes Redfish, AI Control & Four-Tier Reference" v1.2 | cited as MGN-TEL-001 parent, file not held | not found publicly anywhere under any similar title | **RESOLVED same day: Scott confirmed it is an internal ADC document, not an OCP publication — awaiting file drop (SYS-OI-01)** |
